                        ...
                        <div class="row">
                            ...
                            <div class="col-auto">
                                <div class="l-bg-green info-icon">
                                    <i
                                        class="fa fa-users pull-left col-orange font-30"
                                    ></i>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-auto">
                                <div class="col-indigo info-icon">
                                    <i
                                        class="fa fa-book pull-left card-icon font-30"
                                    ></i>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-auto">
                                <div class="col-teal info-icon">
                                    <i
                                        class="fa fa-user pull-left card-icon font-30"
                                    ></i>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-auto">
                                <div class="col-pink info-icon">
                                    <i
                                        class="fa fa-coffee pull-left card-icon font-30"
                                    ></i>
                                </div>
                            </div>
                        </div>
                            ...
                            <table class="table table-striped table-bordered table-hover table-checkable order-column"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="center">Student Nom</th>
        ...
        <div class="row">
                ...
                <div class="white-box border-gray">
                    <h4 class="box-title">
                        <small class="pull-right m-t-10 text-success"
                            ><i class="fa fa-sort-asc"></i> 25 % plus haut que le mois dernier</small
                        >
                        Paiement Valider
                    </h4>
                    <div class="stats-row">
                ...
                <div class="white-box border-gray">
                    <h4 class="box-title">
                        <small class="pull-right m-t-10 text-danger"
                            ><i class="fa fa-sort-desc"></i> 30%  plus bas que le mois dernier</small
                        >Paiement non soldé
                    </h4>
                    <div class="stats-row">
                        <div class="stat-item">
            ...
            <div class="col-md-4 col-sm-12 col-12">
                <div class="white-box border-gray">
                    <h4 class="box-title">
                        <small class="pull-right m-t-10 text-success"
                            ><i class="fa fa-sort-asc"></i> 20% plus haut que le mois dernier</small
                        >Paiement en cours
                    </h4>
                    <div class="stats-row">
                        <div class="stat-item">
                    ...
                    <div class="card-body">
                        <div class="mdl-tabs mdl-js-tabs">
                            <div class="mdl-tabs__tab-bar tab-left-side">
                                <a
                                    href="#tab4-panel"
                                    class="mdl-tabs__tab tabs_three is-active"
                                    >Ce Mois</a
                                >
                                <a
                                    href="#tab5-panel"
                                    class="mdl-tabs__tab tabs_three"
                                    >Cette Semaine</a
                                >
                                <a
                                    href="#tab6-panel"
                            ...
                            <div
                                class="mdl-tabs__panel is-active p-t-20"
                                id="tab4-panel"
                            >
                                <div class="table-responsive">
                                    <table class="table">
