<template>
    ...
    <div class="affichage">
       <div class="avant">
           <h1 class="texte">Incription Non Payé</h1>
           <a href="#">
        ...
        <div class="sections" v-for="(inscription, index) in inscriptions" :key="index">
           ...
           <div class="utilisateur" v-if="inscription.statut===0">
               ...
               <p class="texte" id="n">{{ inscription.eleve.user.nom}} {{ inscription.classe.nom_classe }} {{ inscription.classe.type_classe }} {{ inscription.classe.niveau }}</p>
       ...
       <div class="avant">
           <h1 class="texte">Incription En cours</h1>
           <a href="#">
               <button class="texte ajout mdl" id="openModal" > <i class="fi fi-rr-plus"></i><span>Ajouter</span></button>
           </a>
       </div>
        ...
        <div class="sections" v-for="(inscription, index) in inscriptions" :key="index">
           ...
           <div class="utilisateur" v-if="inscription.statut===1">
               <img src="/assetsCFPT/image/image1.png" alt="Etu" class="petite">
               <p class="texte" id="n">{{ inscription.eleve.id_user}} {{ inscription.classe.nom_classe }}</p>
               <p class="texte" id="n">{{ inscription.annee_academique.intitule }}</p>
               <div  class="presences">
                   <a href="#" class="texte b">
                       <i class="fi fi-rr-edit"></i>
       ...
       <div class="avant">
           <h1 class="texte">Incription Valider</h1>
           <a href="#">
               <button class="texte ajout mdl" id="openModal" > <i class="fi fi-rr-plus"></i><span>Ajouter</span></button>
           </a>
       </div>
        ...
        <div class="sections" v-for="(inscription, index) in inscriptions" :key="index">
           <!-- Répéter la div utilisateur pour un autre utilisateur -->
           <div class="utilisateur" v-if="inscription.statut===2">
               <img src="/assetsCFPT/image/image1.png" alt="Etu" class="petite">
               <p class="texte" id="n">{{ inscription.eleve.id_user}} {{ inscription.classe.nom_classe }}</p>
               <p class="texte" id="n">{{ inscription.annee_academique.intitule }}</p>
               <div  class="presences">
