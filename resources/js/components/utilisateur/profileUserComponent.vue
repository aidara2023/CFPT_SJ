                            ...
                            <div class="card-body no-padding height-9">
                                <div class="row">
                                    <div class="profile-userpic">
                                        <img
                                            :src="getImageUrl(this.authphoto)"
                                    ...
                                    <div v-show="showModal">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <button @click="showModal = false" class=" btn-danger mdl-js-ripple-effect"> 
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button
                                                    type="button"
                                                    class="btn btn-primary" @click="updatePassword">
                                                    Confirmer
                                                </button>
                                            </div>
                                        </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body no-padding height-9">
                                <div class="profile-desc">
                                    Hello I am John Deo a Professor in xyz
                                    College Surat. I love to work with all my
                                ...
                                <ul class="list-group list-group-unbordered">
                                    <li class="list-group-item">
                                        <b>Genre </b>
                                        <div
                                            class="profile-desc-item pull-right"
                                        >
                                            {{ this.authgenre }}
                                        </div>
                                    </li>
                                        ...
                                        >
                                            <div id="biography">
                                                ...
                                                <p class="m-t-30">
                                                    ...
                                                    Arts from the well known and
                                                    renowned institution of
                                                    India – SARDAR PATEL ARTS
                                                    COLLEGE, BARODA in 2000-01,
                                                    which was affiliated to M.S.
                                                    University. I ranker in
                                                    University exams from the
                                                    same university from
                                                    1996-01.
                                                </p>
                                                <p>
                                                    Worked as Professor and Head
                                                    of the department at Sarda
                                                    Collage, Rajkot, Gujarat
                                                    from 2003-2015
                                                </p>
                                                <p>
                                                ...
                                                <ul>
                                                    ...
                                                    <li>
                                                        Three year experience as
                                                        Jr. Professor at V.S.
                                                        Arts & Commerse Collage
                                                        from April - 2008 to
                                                        April - 2011.
                                                    </li>
                                                    <li>
        ...
        <div class="chat-sidebar-container" data-close-on-body-click="false">
            <div class="chat-sidebar">
                ...
                <div class="tab-content">
                    ...
                    >
                        <div
                            class="chat-sidebar-settings-list slimscroll-style"
                        >
                            <div class="chat-header">
    ...
    methods: {
        ...
        getServiceUtilisateurConnecte() {
            axios
                ...
                .catch((error) => {
                    showDialog3("récupération des utilisateurs");
                });
        },
		updatePassword() {
            ...
            // Envoyez une requête à votre backend pour mettre à jour le mot de passe dans la base de données
            // par exemple, en utilisant axios ou fetch
            // Remplacez ceci par votre propre logique d'envoi de requête
            axios.post('/utilisateur/password/'+ this.authid , {
