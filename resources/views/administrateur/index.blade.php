                ...
                <div class="card-box">
                    <div class="card-head">
                        ...
                        <ul class="mdl-menu mdl-menu--bottom-right mdl-js-menu mdl-js-ripple-effect"
                            ...
                            <li class="mdl-menu__item"><i
                                    class="material-icons">favorite</i>Something else
                                here</li>
                        </ul>
                    </div>
                    <div class="card-body ">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="box-title"><small class="pull-right small-lbl-red"><i
                                    class="far fa-arrow-alt-circle-down"></i> 12% Lower</small>
                            New
                            Admissions</div>
                        <div class="mt-3">
                            <div class="stat-item">
                                ...
                                <table class="table display product-overview mb-30"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span
                                                    class="label label-sm label-danger">unpaid</span>
                                            </td>
                                            <td>Mechanical</td>
                                            <td>
                                                <a href="javascript:void(0)" class="tblEditBtn">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span
                                                    class="label label-sm label-warning ">unpaid</span>
                                            </td>
                                            <td>Science</td>
                                            <td>
                                                <a href="javascript:void(0)" class="tblEditBtn">
