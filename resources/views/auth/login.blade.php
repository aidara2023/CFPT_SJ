...
<body>
    <div id="app">
        ...
        <div class="container ">
            <div class=" border"
                style="width: 50%; height: 83%; background: rgba(245, 241, 241, 0.66); box-shadow: -2px 5px 22.899999618530273px -2px #595353; border-radius: 16px; backdrop-filter: blur(29.50px)">
