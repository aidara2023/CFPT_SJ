...
<div class="elements flou " id="app">
    ...
    <div class="entete">
     ...
     <liste-dossier_medical></liste-dossier_medical>
  ...
  <!--   {{--  Debut modal pour ajouter utilisateur --}} -->
        <dossier_medical-create></dossier_medical-create>
   ...
   <!--  {{--  Fin modal pour supprimer utilisateur --}} -->
    ...
    <dialog data-modal-confirmation class="modal">
        ...
        <h1>Réussi !</h1>
        <br>
        <p class="">dossier_medical ajouté avec succès</p>
    </dialog>
    ...
    <dialog data-modal-confirmation-sup class="modal">
        ...
        <h1>Réussi !</h1>
        <br>
        <p class="">dossier_medical supprimé avec succès</p>
    </dialog>
    ...
    <dialog data-modal-confirmation-modifier class="modal">
        ...
        <h1>Réussi !</h1>
        <br>
        <p class="">dossier_medical modifier avec succès</p>
    </dialog>
