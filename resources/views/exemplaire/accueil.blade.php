...
<div class="elements flou " id="app">
    ...
    <div class="entete">
     ...
     <liste-exemplaire></liste-exemplaire>
  ...
  <!--   {{--  Debut modal pour ajouter utilisateur --}} -->
        <exemplaire-create></exemplaire-create>
   ...
   <!--  {{--  Fin modal pour supprimer utilisateur --}} -->
    ...
    <dialog data-modal-confirmation class="modal">
        ...
        <h1>Réussi !</h1>
        <br>
        <p class="">exemplaire ajouté avec succès</p>
    </dialog>
    ...
    <dialog data-modal-confirmation-sup class="modal">
        ...
        <h1>Réussi !</h1>
        <br>
        <p class="">exemplaire supprimé avec succès</p>
    </dialog>
    ...
    <dialog data-modal-confirmation-modifier class="modal">
        ...
        <h1>Réussi !</h1>
        <br>
        <p class="">exemplaire modifier avec succès</p>
    </dialog>
