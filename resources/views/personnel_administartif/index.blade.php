...
<div class="elements flou " id="app">
    ...
    <div class="entete">
     ...
     <liste-personnel-administratif></liste-personnel-administratif>
  ...
  <!--   {{--  Debut modal pour ajouter utilisateur --}} -->
   ...
   <!--  {{--  Fin modal pour supprimer utilisateur --}} -->
    ...
    <dialog data-modal-confirmation class="modal">
        ...
        <h1>Réussi !</h1>
        <br>
        <p class="">Personnel Administratif ajouté avec succès</p>
    </dialog>
    ...
    <dialog data-modal-confirmation-sup class="modal">
        ...
        <h1>Réussi !</h1>
        <br>
        <p class="">Personnel Administratif supprimé avec succès</p>
    </dialog>
