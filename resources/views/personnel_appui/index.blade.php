...
<div class="elements flou " id="app">
    ...
    <div class="entete">
     ...
     <liste-personnel-appui></liste-personnel-appui>
  ...
  <!--   {{--  Debut modal pour ajouter utilisateur --}} -->
        <personnel-appui-create></personnel-appui-create>
   ...
   <!--  {{--  Fin modal pour supprimer utilisateur --}} -->
    ...
    <dialog data-modal-confirmation class="modal">
        ...
        <h1>Réussi !</h1>
        <br>
        <p class="">Personnel Appui ajouté avec succès</p>
    </dialog>
    ...
    <dialog data-modal-confirmation-sup class="modal">
        ...
        <h1>Réussi !</h1>
        <br>
        <p class="">Personnel Appui supprimé avec succès</p>
    </dialog>
